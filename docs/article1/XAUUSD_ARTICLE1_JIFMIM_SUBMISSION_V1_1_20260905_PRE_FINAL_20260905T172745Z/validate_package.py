...
def main() -> None:
    ...
    # CAS 2.4 emits one empty front-matter box warning at \maketitle. Any other
    # overfull box is treated as a content-layout failure.
    ...
    require(cas_frontmatter_warnings == 3, "unexpected CAS front-matter warning count")
