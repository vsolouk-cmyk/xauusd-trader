...
RELEASE_NAME = "XAUUSD_ARTICLE1_JIFMIM_COMPLETE_SUBMISSION_PACKAGE_FINAL_20260905.zip"
...
PACKAGE_FILES = [
    ...
    "validate_package.py", "make_release.py", "github_repository_audit.sh",
    "cas-sc.cls", "cas-common.sty", "cas-model2-names.bst",
    "supp_registry_table.tex", "supp_spec_table.tex", "supp_family_table.tex",
    "supp_crossfeed_table.tex", "supp_alignment_table.tex", "supp_dsr_table.tex",
    *DATA_FILES[:13], SOURCE_NAME, DATA_NAME, MANIFEST_NAME,
]
...
def main() -> None:
    require_files(SOURCE_FILES + DATA_FILES)
